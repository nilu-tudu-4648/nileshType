...
const FuturePickupScreen: React.FC<FuturePickupScreenProps> = ({ navigation }: any) => {
  ...
  const { loading, futurepickUp, cancelrequestRentBookingData, transferRentbooking, webuserupdate } = useAppSelector((state) => ({
    loading: state.entities.pickupStore.loading,
    futurepickUp: state.entities.pickupStore.futurepickUp,
...
export default FuturePickupScreen;