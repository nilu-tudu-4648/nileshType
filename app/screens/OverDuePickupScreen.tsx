...
const OverDuePickupScreen: React.FC<OverDuePickupScreenProps> = ({ navigation }: any) => {
  ...
  const { loading, overduepickUp, cancelrequestRentBookingData, transferRentbooking, webuserupdate } = useAppSelector((state) => ({
    loading: state.entities.pickupStore.loading,
    overduepickUp: state.entities.pickupStore.overduepickUp,
